...
public boolean cekUsername(String username) {
    ...
    try {
        // Validasi jika input ID Pegawai kosong
        if (txtidpegawai.getText().isEmpty()) {
            // Gunakan 0 sebagai placeholder atau biarkan kosong untuk AUTO_INCREMENT
            pegawai.setIdpegawai(0); 
        } else {
            pegawai.setIdpegawai(Integer.parseInt(txtidpegawai.getText())); // Ambil idpegawai dari input
        }
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "ID Pegawai harus berupa angka.", "Kesalahan Input", JOptionPane.ERROR_MESSAGE);
    ...
    pegawai.setPassword(new String(jppassword.getPassword())); // Password

    // Simpan ke database
    try {
        pegawai.save();
        txtidpegawai.setText(Integer.toString(pegawai.getIdpegawai())); // Perbarui ID setelah simpan
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Terjadi kesalahan saat menyimpan data pegawai.", "Kesalahan", JOptionPane.ERROR_MESSAGE);
        e.printStackTrace();
    }
